...
for n_txt, n in noise_values:
    files.append((f'ouput\\multiple\\out_boris{n_txt}_e_base_attack.txt', n, 'Baseline'))
    for t_txt, t in vote_values:
        print(n, t)
        #files.append((f'KPredictions_outputs\\out_boris{n_txt}_e_cpt{t_txt}_attack.txt', n, t))
