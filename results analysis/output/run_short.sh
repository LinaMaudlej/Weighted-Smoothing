...
python3 train.py --weight-noise --adv --cpni  --smooth mcpredict --vote_thresh 0.10 --attack epgd --schedule 200 300 --epochs 5 --m_test 16 --m_train 16 --noise_sd 0.2 > out_boris_test2.txt
