...
vote_values = [('005', 0.05), ('10', 0.1), ('15', 0.15), ('20', 0.2), ('25', 0.25)]
vote_values = [('005', 0.05)]

for n_txt, n in noise_values:
    files.append((f'output/multiple/out_boris{n_txt}_e_base_attack_m.txt', n, 'Baseline'))
    for t_txt, t in vote_values:
        print(n, t)
        files.append((f'Threshold_outputs/out{n_txt}_t{t_txt}_attack.txt', n, t))
